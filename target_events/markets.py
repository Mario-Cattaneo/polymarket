...
def is_ethereum_15min_market(question: str) -> bool:
    ...
    Pattern: "Ethereum Up or Down - [Month] [Day], [Time]-[Time] ET"
    """
    # Match pattern like "Ethereum Up or Down - January 6, 3:15AM-3:30AM ET"
...
def analyze_markets():
    """
    Main function to fetch all markets and count Ethereum 15-min markets.
    """
    ...
    # Count and collect Ethereum 15-min markets
    eth_15min_markets = []
    ...
    print(f"\nEthereum Up or Down (15-min) markets found: {len(eth_15min_markets)}")
    
    if eth_15min_markets:
        print("\nSample Ethereum 15-min markets:")
    ...
    print(f"  Ethereum 15-min markets: {len(eth_15min_markets)}")
